...
(function(Ea, P, k) {
    var O = function(h) {
        ...
        m.defaults = {aaData: null, aaSorting: [[0, "asc"]], aaSortingFixed: [],
            ...
            }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {oAria: {sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending"}, oPaginate: {sFirst: "First", sLast: "Last", sNext: "Siguiente", sPrevious: "Antes"}, sEmptyTable: "No data available in table", sInfo: "Mostrando _START_ a _END_ de _TOTAL_ Items", sInfoEmpty: "Mostrando 0 a 0 de 0 Items", sInfoFiltered: "(filtrado de _MAX_ total items)",
                sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Mostrar _MENU_ Primeros", sLoadingRecords: "Cargando...", sProcessing: "Processing...", sSearch: "Buscar:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "No existe ningun item"}, oSearch: h.extend({}, m.models.oSearch), sAjaxDataProp: "data", sAjaxSource: null, sDom: "lfrtip", searchDelay: null, sPaginationType: "simple_numbers", sScrollX: "", sScrollXInner: "", sScrollY: "", sServerMethod: "GET", renderer: null};
        V(m.defaults);
